...
<details>
  ...
  <p class="audit-text">Each card below includes an inline recommendation intended as a working space for future reviewers to capture environment-specific notes and decisions.</p>
  <div class="audit-list">
    <div class="audit-card">
